  ...
  <form action="process.php" method="post">
    ...
    <fieldset>
      <legend>Customer Information</legend>
        ...
        <input type="text" id="first_name" name="first_name" minlength=3 maxlangth = 20 >
        <label for="last_name">Last name</label>
        <input type="text" id="last_name" name="last_name" minlength=3 maxlangth = 20 >
        <label for="phone">Phone number</label>
        <input type="tel" id="phone" name="phone" minlength=10 maxlangth = 10   placeholder="555-123-4567">
        <label for="address">Address</label>
        <input type="address" id="address" name="address" minlength=6 maxlangth = 25 >
        <label for="email">Email Address</label>
        <input type="email" id="email" name="email" minlength=6 maxlangth = 30 >
    </fieldset>
